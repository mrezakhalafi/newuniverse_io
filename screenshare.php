...
<?php require_once($_SERVER['DOCUMENT_ROOT'] . '/screensharing-meta.php'); ?>
...
<style>
  ...
  .productBanner-alt{
    background-image: url('newAssets/product/bi5.webp') !important;
...
<header class="productBanner-alt">
  ...
  <div class="row px-5 pt-5 mt-3 pb-5 mb-5">
    ...
    <div class="col-md-5 pt-5">
      <h1 data-translate='screenshare-1' class="mb-3 fontRobBold" style="font-size: 40px; color: #262626;"></h1>
      <p data-translate='screenshare-2' class="text-left pr-0 pr-lg-5 fs-20" style="font-family: 'Josefin Sans'; font-weight: 300 !important; color:#262626;"></p>
