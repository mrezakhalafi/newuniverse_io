...
move_uploaded_file($_FILES['file']['tmp_name'], 'uploadsFile/' . $_FILES['file']['name']);

$query = $dbconn->prepare("INSERT INTO CHAT_MESSAGE (TO_USER_ID, FROM_USER_ID, CHAT_MESSAGE, TYPE, STATUS) VALUES (?, ?, ?, 1, 1)");
$query->bind_param("iis", $_POST['to_user_id'], $_SESSION['user_id'], $_FILES['file']['name']);
if ($query->execute()) {
