...
<div id="chatSection" class="animated">
	<div class="card shadow border-0" style="width: 350px; height: 400px;">
		<div class="card-header" style="background-color: #01686d; padding: 0px 20px; margin-bottom: 5px;">
			...
			<div id="headerChat" class="animated fadeIn d-none py-2">
				<img src="cb-logo.png" class="mr-2" style="max-height: 40px; width: auto;">
				<p class="fontRobReg fs-20 text-light d-inline m-0 align-self-center">Customer Support</p>
...
<img src="<?php echo base_url(); ?>newAssets/chat bawah.svg" style="max-width: 40px; height: auto; display: block;" class="animated zoomIn" id="showChat" onclick="showChat(); getFocus();">

<img src="<?php echo base_url(); ?>newAssets/Close.svg" style="max-width: 40px; height: auto; display: none;" class="animated zoomIn" id="closeChat" onclick="closeChat();">
