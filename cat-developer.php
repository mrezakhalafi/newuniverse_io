...
<style>
    ...
    @media screen and (max-width:991px) {
      ...
      padding: 3rem 0 0 0 !important;
        ...
        #post_ID_body .col-md-4,
        #post_ID_body .col-md-6 {
            flex: 0 0 100% !important;
            max-width: 100%;
        }
...
<a href="blog-index.php">
    <h1 id="titleText" data-translate="blogindex-10" class="text-center home-title" style="font-family:'Poppins', sans-serif; font-weight: bold !important; color: #1799ad; font-size: 35px;">News & Update</h1>
</a>

<div class="filter-container">
    <div class="row">
        <div class="col-md-12">
            <a data-translate="blogindex-2" class="btn dropdown-toggle" href="#" role="button" id="categoryDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="color:black!important; vertical-align: middle !important; float:left; font-size: 18px">
            </a>
                ...
                <div class="card h-100 text-center">
                    <div class="card-body">
                        ...
                        <a href="<?php echo base_url(); ?>blog-content.php?id=<?php echo ($bp['ID']); ?>" class="blog-title-links">
                            <h5 style="font-size: 14px" class="card-title fontRobBold"><?php echo ($bp['TITLE']); ?>
                            </h5>
                        </a>
                ...
                <div class="card h-100 text-center">
                    <div class="card-body">
                        ...
                        <a href="<?php echo base_url(); ?>blog-content.php?id=<?php echo ($bpd['ID']); ?>" class="blog-title-links">
                            <h5 style="font-size: 14px" class="card-title fontRobBold"><?php echo ($bpd['TITLE']); ?>
                            </h5>
                        </a>
                        <p class="josefin-sans">
                            <?php foreach ($blogtag as $bt) {
