...
include_once($_SERVER['DOCUMENT_ROOT'] . '/corsproxy.php');
...
<html><body>
    <script>
        ...
        $.ajax({
            type: "POST",
            url: <?php echo base_url() . "corsproxy.php?url=https://uatmb.com:41405/eWallet/RequestAuthentication";?>,
            headers: {
        ...
        $.ajax({
            type: "POST",
            url: <?php echo base_url() . "corsproxy.php?url=https://uatmb.com:41405/eWallet/RequestTransactionPayment";?>,
            headers: {
