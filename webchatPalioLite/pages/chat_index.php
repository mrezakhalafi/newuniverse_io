...
if (!isset($_SESSION['web_login'])) {
	redirect(base_url() . 'webchat/pages/login_page.php');
}
...
<body>
		...
		<div class="row h-100">
			<div class="col-12 col-sm-5 col-md-4 d-flex flex-column" id="chat-list-area" style="position:relative; max-height: 100%; overflow-y: auto;">
				...
				<div class="row d-flex flex-row align-items-center p-2" id="navbar">
					<img alt="Profile Photo" class="img-fluid rounded-circle mr-2" style="height:50px; width:50px; cursor:pointer;" onclick="showProfileSettings()" id="display-pic">
					<div class="w-50">
			...
			<div class="d-none d-sm-flex flex-column col-12 col-sm-7 col-md-8 p-0 h-100" id="message-area">
				...
				<div class="row d-flex flex-row align-items-center p-2 m-0 w-100" id="navbar">
					...
					<div class="d-flex flex-row align-items-center ml-auto">
						...
						<i class="fas fa-paperclip mx-3 text-white d-none d-md-block dropdown-toggle" data-toggle="dropdown" data-target="attachments"></i>
			...
			<!-- info area -->
			<div class="col-12 col-sm-5 col-md-4 d-none flex-column" id="info-area" style="position:relative;">
				...
				<div class="d-flex flex-column w-100 h-100" id="info-detail">
					...
					<div class="d-flex flex-column" style="overflow:auto;">
						...
						<div class="bg-white px-3 py-2 d-none" id="members-section">
	...
	<?php require_once('palio-button.php'); ?>
	...
	<script src="../assets/js/fetch_company_alias.js"></script>
	<script src="../assets/js/fetch_complaint.js"></script>
	<script src="../assets/js/fetch_complaint_history.js"></script>
	<script src="../assets/js/fetch_user_type.js"></script>
	<script src="../assets/js/fetch_friend_list.js"></script>
	...
	<script src="../assets/js/fetch_notif_periodic.js"></script>
	<script src="../assets/js/script.js"></script>

	<!-- <script>
		$(window).on('load', function() {
			// init func from script.js to wait for the profile to load first
			// init();
		});
	</script> -->
