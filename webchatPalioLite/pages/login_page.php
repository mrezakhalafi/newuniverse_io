      ...
      <div style="margin-top: 100px;" class="container bg-white w-75 p-5 shadow">
        <div class="row m-lg-4">
          <div class="col-md-8 order-2">
            <div class="title">To use catchUp on your computer:</div>
            <!-- LIST PENGGUNAAN-->
            <ol class="_1TxZR mb-5">
              <li>Open your catchUp mobile app.</li>
              <li>Open settings menu by pressing catchUp logo on the upper left corner, and go to "Web Login" menu.</li>
            ...
            <ul class="_1TxZR">
              ...
              <li>If you haven't installed catchUp, please do so.</li>
            </ul>
