    ...
    <div class="row" id="heading">
        <div class="col-lg-8 col-md-12">
            <h1 class="fontRobBold mb-5 tagline">
                Masa depan bekerja ada di sini.<br>
                Kerja di mana saja, kapan saja.
            </h1>
            <div class="row mb-4">
                <div class="col-lg-8 col-md-12">
...
<div class="container mb-5">
    ...
    <div class="row my-4">
        <div class="col-md-12 text-center">
            <button class="btn btn-green" id="see-more" href="ucaas-features.php" style="color:white;">Pelajari lebih lanjut <i class="fa fa-chevron-circle-down"></i></button>
        </div>
    </div>
</div>
                ...
                <div class="row">
                    <div class="col-lg-3 align-self-center">
                        <h1 class="ny-auto tagline fontRobBold">
                            ...
                            <span style="color:white;">Pantau dan catat pekerjaan Anda</span>
                        </h1>
                    </div>
                        ...
                        <div class="card card-lg">
                            <div class="card-body">
                                ...
                                <p class="fontRobReg card-text m-0 fs-18">
                                    ...
                                    Tugaskan pekerjaan pada orang yang tepat.
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card card-lg">
                            <div class="card-body">
                                ...
                                <p class="fontRobReg card-text m-0 fs-18">
                                    ...
                                    Kelola semua tugas yang sedang berjalan, yang akan datang, dan yang terlambat.
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card card-lg">
                            <div class="card-body">
                                ...
                                <p class="fontRobReg card-text m-0 fs-18">
                                    ...
                                    Selalu ada untuk mengingatkan Anda tentang tanggal-tanggal penting.
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-3 align-self-center ml-auto order-lg-2">
                        <h1 class="tagline fontRobBold ml-auto">
                            ...
                            <span style="color:#01686d;">Masa depan produktivitas</span>
                        </h1>
                    </div>
                                                ...
                                                <div class="card card-lg">
                                                    <div class="card-body">
                                                        ...
                                                        <p class="fontRobReg card-text m-0 fs-18">
                                                            ...
                                                            Kelola semua keuangan Anda seperti pengembalian, permintaan kas, dan klaim lembur.
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="card card-lg">
                                                    <div class="card-body">
                                                        ...
                                                        <p class="fontRobReg card-text m-0 fs-18">
                                                            ...
                                                            Rekam absensi harian Anda, lembur, dan cuti.
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="card card-lg">
                                                    <div class="card-body">
                                                        ...
                                                        <p class="fontRobReg card-text m-0 fs-18">
                                                            ...
                                                            Adakan pertemuan dengan siapapun, kapanpun, dan di mana pun.
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="card card-lg">
                                                    <div class="card-body">
                                                        ...
                                                        <p class="fontRobReg card-text m-0 fs-18">
                                                            ...
                                                            Kelola dan solusikan keluhan pelanggan dengan orang yang tepat.
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="card card-lg">
                                                    <div class="card-body">
                                                        ...
                                                        <p class="fontRobReg card-text m-0 fs-18">
                                                            ...
                                                            Jadwalkan dan kelola tugas-tugas, pertemuan, dan perjanjian Anda.
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-4 card-track">
                                                <div class="card card-lg">
                                                    <div class="card-body">
                                                        ...
                                                        <p class="fontRobReg card-text m-0 fs-18">
                                                            Selenggarakan acara Anda dan kabarkan semua orang yang Anda perlukan.
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="card card-lg">
                                                    <div class="card-body">
                                                        ...
                                                        <p class="fontRobReg card-text m-0 fs-18">
                                                            ...
                                                            Pesan supir untuk bepergian ke tempat yang Anda perlukan.
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                ...
                <div class="card card-lg mb-5">
                    <div class="card-body">
                        ...
                        <p class="fontRobReg card-text m-0 fs-18">
                            ...
                            Berkenalan dengan orang yang tidak bekerja langsung bersama Anda.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-4 mx-auto">
                <div class="card card-lg card-yellow text-center">
                    ...
                    <div class="card-footer">
                        <a class="btn btn-green" href="contactus-ib.php">Hubungi Sales</a>
                    </div>
                </div>
            </div>
        </div>
