  ...
  <nav class="navbar navbar-expand-lg navbar-dark fixed-top px-0" id="navtop-alt" style="transition: top 0.3s;">
    <div class="container" style="max-width: 90%">
      <a class="navbar-brand fontRobReg" href="<?php echo base_url(); ?>index.php">
        ...
        <!-- <span class="my-auto fontRobBold" style="font-size:30px; color:#f4bc39;">catch</span><span class="my-auto fontRobBold" style="font-size:30px; color:#5380ef;">Up</span> -->
      </a>
      ...
      <div class="collapse navbar-collapse" id="navbar-section">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item">
            <a class="nav-link nav-menu-link fontRobReg fs-18 greenText" href="<?php echo base_url(); ?>palio-ucaas.php" style="color: #1a73e8;">UCaaS</a>
          </li>
          <li class="nav-item">
            <a class="nav-link nav-menu-link fontRobReg fs-18 greenText" href="<?php echo base_url(); ?>palio-cpaas.php" style="color: #1a73e8;">CPaaS</a>
          </li>
          <li class="nav-item">
            <a class="nav-link nav-menu-link fontRobReg fs-18 greenText" href="videoconference.php" style="color: #1a73e8;">Video Conference</a>
          </li>
          <li class="nav-item">
            <a class="nav-link nav-menu-link fontRobReg fs-18 greenText" href="telemedicine.php" style="color: #1a73e8;">Telemedicine</a>
          </li>
        </ul>
      </div>
    </div>
