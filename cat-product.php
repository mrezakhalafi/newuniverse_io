            ...
            <div class="col-md-4 mb-3 blog-post" id="card-<?php echo $key; ?>">
                ...
                <div class="card h-100 text-center">
                    <div class="card-body">
                        ...
                        <a data-translate="blogindex-7" style="font-size: 14px" href="<?php echo base_url(); ?>blog-content.php?id=<?php echo ($bp['ID']); ?>" class="btn btn-blog">Read More</a>
                    </div>
                </div>
            </div>
        <?php } ?>
            ...
            <div class="col-md-4 mb-3 blog-post" id="card-<?php echo $key; ?>">
                ...
                <div class="card h-100 text-center">
                    <div class="card-body">
                        ...
                        <a data-translate="blogindex-7" style="font-size: 14px" href="<?php echo base_url(); ?>blog-content.php?id=<?php echo ($bpd['ID']); ?>" class="btn btn-blog">Read More</a>
                    </div>
                </div>
            </div>
        <?php } ?>
