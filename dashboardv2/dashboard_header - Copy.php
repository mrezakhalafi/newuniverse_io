...
<head>
  ...
  <!-- custom css -->
  <link rel="stylesheet" href="css/custom.css?<?php echo $ver; ?>">
      ...
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
            <span class="dropdown-item dropdown-header"><?php echo ($billsrow + $rowsnull); ?> Notifications</span>
            <div class="dropdown-divider"></div>
            <a href="mailbox.php" class="dropdown-item">
              <i class="fas fa-envelope mr-2"></i> <?php echo $rowsnull; ?> new messages
              <!-- <span class="float-right text-muted text-sm">3 mins</span> -->
            </a>
            <div class="dropdown-divider"></div>
            <a href="billpayment.php" class="dropdown-item">
              <i class="fas fa-file mr-2"></i> <?php echo $billsrow; ?> unpaid bills
