                                ...
                                <div id="generate-apk-form">
                                    ...
                                    <div class="row mb-5">
                                        <div class="col-sm-12 col-md-6 left">
                                            ...
                                            <input type="textarea" id="companyName" class="form-control" name="company-name" placeholder="Company Name" required>
                                        </div>
                                        <div class="col-sm-12 col-md-6 right">
                                            <label for="appId">Your app id <span style="color:red;">*</span> :</label>
                                            <input type="textarea" id="appId" class="form-control" name="app-id" placeholder="com.example" required>
                                        </div>
                                    </div>

                                    <div class="row mt-5">
                                        <div class="col-md-12">
                                            <label class="genapkcheckbox" for="enable_category"> Add content category
                                                <input type="checkbox" id="enable_category" name="enable_category" value="1">
                                                <span class="checkmark"></span>
                                            </label>
                                            <p style="font-size:.85rem;">Check this box if you want to add content categories for your app's content.</p>
                                        </div>
                                    </div>
                                    ...
                                    <h6 class="mt-5"><strong>APK Settings</strong></h6>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="row mt-3">
                                            ...
                                            <div class="check-existing-image mt-2 mb-4">
                                                ...
                                                <?php if(isset($oldBG)): ?>
                                                    <div class="text-success"><b>Existing Background Image Found.</b></div>
                                                <?php endif; ?>
                                            ...
                                            <?php if(isset($oldBG)): ?>
                                                <label class="genapkcheckbox mt-2 mb-5" for="use-old-bg"> I want to use old background
                                            ...
                                            <div class="row mt-5">
                                                <div class="col-md-12">
                                                    <p style="font-size:.85rem;">
                                                        If you wish to publish your app on the Huawei App Gallery, you need to provide your Push Kit JSON file. Otherwise, leave this field empty.
                                                    </p>
                                                </div>
                                            </div>
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8">
                                                    ...
                                                    <p id="huawei_pushkit_validation" style="font-size:.85rem; color:red;" class="d-none">
                                                        Please make sure the value for <strong>package_name</strong> in your JSON file match the app ID above.
                                                    </p>
                                                </div>
                                            </div>
        ...
        <div class="modal-content">
            <div class="modal-body">
                ...
                <div class="text-center">
                    ...
                    <p class="mt-4">Usually takes about <b>12-15 minutes.</b></p>
                    <div id="build-start-time"></div>
                    <div id="build-end-time" class="mb-3"></div>
                </div>
            </div>
            <!-- </form> -->
        </div>
