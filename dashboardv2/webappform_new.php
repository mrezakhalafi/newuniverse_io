                                ...
                                <div id="generate-apk-form">
                                    ...
                                    <div class="row mb-5">
                                        <div class="col-sm-12 col-md-6 left">
                                            ...
                                            <input type="textarea" id="companyName" class="form-control" name="company-name" placeholder="Company Name" value="<?php if ($query_one_result['COMPANY_NAME'] != ""): echo $query_one_result['COMPANY_NAME']; endif;?>">
                                        </div>
                                        <div class="col-sm-12 col-md-6 right">
                                            <label for="appId" data-translate="dashform-10">Your app id <span style="color:red;">*</span> :</label>
                                            <input type="textarea" id="appId" class="form-control" name="app-id" placeholder="com.example" value="<?php if ($query_one_result['APP_ID'] != ""): echo $query_one_result['APP_ID']; endif;?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="row mt-3">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" id="ver_name" class="form-control mb-1" name="ver_name" value="<?php if ($query_one_result['VERSION_NAME'] != ""): echo $query_one_result['VERSION_NAME']; endif;?>" required>
...
<script src="js/webappform_new.js?<?php echo $version; ?>"></script>
