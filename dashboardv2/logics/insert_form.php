...
$sqlInsertForm = "INSERT INTO `FORM` (`FORM_ID`,`TITLE`,`CREATED_DATE`,`CREATED_BY`, `STATUS`) VALUES ('$form_id','$title','$timestamp','$user_id', '0')";
// echo $sqlInsertForm;
$query = $dbconn->prepare($sqlInsertForm);
$query->execute();
