...
$(document).ready(function () {
    ...
    if ($("#im_check").val() == 1) {
        $("#im_check").prop('checked', true);
    } else {
        $("#im_check").prop('checked', false);
    }
    ...
    var maven_be = "Copy this version Library to replace nexilis version in the Palio Lite app level build.gradle file.";
    var maven_email = "Copy this email to replace email in the Palio Lite app level build.gradle file.";

    $("#maven-uname").attr("title", maven_uname);
    $("#maven-pass").attr("title", maven_pw);
    $("#maven-be").attr("title", maven_be);
    $("#maven-email").attr("title", maven_email);
...
function copyElementText5() {
    var text = document.getElementById("be_version").innerText.trim();
    // console.log(text);
    var elem = document.createElement("textarea");
    document.body.appendChild(elem);
    elem.value = text;
    ...
    document.execCommand("copy");
    document.body.removeChild(elem);
    $("#copied-maven-be").show();
    let timeout = setTimeout(function () {
        $("#copied-maven-be").hide();
    }, 3000);
    // $('#copypassword').attr('value', 'Copied').attr("disabled", "disabled");
}

function copyElementText6() {
    var text = document.getElementById("email_username").innerText.trim();
    // console.log(text);
    var elem = document.createElement("textarea");
    document.body.appendChild(elem);
    elem.value = text;
    ...
    document.execCommand("copy");
    document.body.removeChild(elem);
    $("#copied-maven-email").show();
    let timeout = setTimeout(function () {
        $("#copied-maven-email").hide();
    }, 3000);
    // $('#copypassword').attr('value', 'Copied').attr("disabled", "disabled");
}
