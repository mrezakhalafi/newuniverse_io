<?php
  ...
  $store = include_once($_SERVER['DOCUMENT_ROOT'] . '/persib_web/logics/fetch_stores_raw.php');
  ...
  if (substr($store_thumb_id,0,4) !== "http") {
    $store_thumb_id = "/palio_browser/images/" . $store_thumb_id;
  }
...
<html lang="en">
  ...
  <body>
    ...
    <img src="/persib_web/assets/img/idn_nature_<?php echo $rand_bg;?>" style="display:none;" alt="" />
    <div class="profile-header jumbotron jumbotron-fluid mx-auto text-center" style="background-image:url(/persib_web/assets/img/idn_nature_<?php echo $rand_bg;?>)">
      ...
      <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
        ...
        <div class="container-fluid" id="info-container">
          <div class="row">
            ...
            <div class="col-auto ml-4 text-left my-auto">
              <?php 
          ...
          <div class="row">
            ...
            <?php } else { ?>
              <input class="col-auto ml-4 text-left my-auto profile-input" placeholder="Alamat Email" disabled/>
            <?php } ?>
            <!-- <div class="col-auto ml-4 text-left my-auto">
              <?php 
                // echo '<a href="mailto:"' . $store_email . '">' . $store_email . '</a>';
          ...
          <div class="row">
            ...
            <input class="col-auto ml-4 text-left my-auto profile-input" value="<?php echo $phone_number; ?>" placeholder="Nomor Telepon" disabled/>
            <div class="col-auto ml-4 text-left my-auto">
            </div>
          </div>
          <div class="row">
            ...
            <?php } else if ($store_isArtist) { ?>
              <input class="col-auto ml-4 text-left my-auto profile-input" placeholder="Situs Artis" disabled/>
            <?php } else { ?>
              <input class="col-auto ml-4 text-left my-auto profile-input" placeholder="Situs Toko" disabled/>
            <?php } ?>
          </div>
          <div class="row" style="border-bottom: 1px solid #e6e6e6;">
            <div class="col-1">
            ...
            <?php } else if ($store_isArtist) { ?>
              <input class="col-auto ml-4 text-left my-auto profile-input" placeholder="Alamat Artis" disabled/>
            <?php } else { ?>
              <input class="col-auto ml-4 text-left my-auto profile-input" placeholder="Alamat Toko" disabled/>
            <?php } ?>
            <div class="col-auto ml-4 text-left my-auto">
            </div>
          </div>
