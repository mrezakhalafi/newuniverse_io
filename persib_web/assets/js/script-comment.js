function commentProduct($productCode) {
            ...
            xmlHttp.onreadystatechange = function () {
                if (xmlHttp.readyState == 4 && xmlHttp.status == 200) {
                    if (xmlHttp.responseText == 'Success Comment') {
                        ...
                        if (window.Android) {
                            window.Android.onCommentPosted();
                        }
                    }
                }
            }
            xmlHttp.open("post", "/persib_web/logics/comment_product");
    ...
    //     }
    // }
    // xmlHttp.open("post", "/persib_web/logics/comment_product.php");
    // xmlHttp.send(formData);
}
...
class SuccessModal {
    ...
    constructor(commentId, method) {
        this.modalTitle = "Kamu yakin ingin menghapus komentar ini?";
    ...
    question() {
        return new Promise((resolve, reject) => {
            ...
            this.acceptButton.addEventListener("click", () => {
                ...
                xmlHttp.open("post", "/persib_web/logics/delete_comment");
                xmlHttp.send(formData);
            });
