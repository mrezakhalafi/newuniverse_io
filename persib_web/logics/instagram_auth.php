...
// https://api.instagram.com/oauth/authorize?client_id=4328628943838644&redirect_uri=https://palio.io/persib_web/logics/instagram_auth.php&scope=user_profile,user_media&response_type=code

$auth_code = $_GET['code'];
$code = str_replace("#_", "", $auth_code);
$client_id = '4328628943838644';
$client_secret = 'a9435aa306d86219feb4092e50bdbcc5';
$redirect = 'https://palio.io/persib_web/logics/instagram_auth.php';
