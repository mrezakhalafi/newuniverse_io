...
$sql = "SELECT p.*, s.CODE as STORE_CODE, s.NAME as STORE_NAME, s.THUMB_ID as STORE_THUMB_ID, s.LINK as STORE_LINK, s.CATEGORY as CATEGORY, s.TOTAL_FOLLOWER as TOTAL_FOLLOWER, s.IS_VERIFIED as IS_STORE_VERIFIED FROM PRODUCT p join SHOP s on p.SHOP_CODE = s.CODE";
