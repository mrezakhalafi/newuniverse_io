...
CREATE TABLE `ACTIVITY_HISTORY` (
  ...
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=15173 DEFAULT CHARSET=latin1;
...
CREATE TABLE `CREDIT` (
  ...
  `PREPAID_QUOTA` double NOT NULL DEFAULT '0',
  `CE_QUOTA` double NOT NULL DEFAULT '17800000',
  PRIMARY KEY (`ID`)
...
CREATE TABLE `SDK` (
  ...
  `MOBILE_CONTACT_CENTERS` int(11) NOT NULL DEFAULT '0',
  `PUSH_NOTIFICATIONS` int(11) NOT NULL DEFAULT '0',
  `UNIFIED_MESSAGING` int(11) NOT NULL DEFAULT '0',
  `LIVE_VIDEO_STREAMING` int(11) NOT NULL DEFAULT '0',
  `VIDEO_CALL` int(11) NOT NULL DEFAULT '0',
  `VOIP_CALL` int(11) NOT NULL DEFAULT '0',
...
CREATE TABLE `SERVER_ADDRESS` (
  ...
  `PORT_ANDROID` varchar(12) DEFAULT NULL,
  `PORT_IOS` varchar(12) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `USAGE_DETAIL` (
  ...
  `FROM` varchar(256) DEFAULT NULL,
  `TO` varchar(256) DEFAULT NULL,
  `CONTENT_ID` varchar(245) DEFAULT NULL,
  `CONTENT` varchar(1000) DEFAULT NULL,
  `USAGE_DATE` datetime NOT NULL,
  `DURATION` int(11) DEFAULT NULL,
  `CREATED_AT` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  ...
  `RATE_AMOUNT` double DEFAULT NULL,
  PRIMARY KEY (`ID`)
...
CREATE TABLE `WEB_LOGIN` (
  ...
  `F_PIN` varchar(11) DEFAULT NULL,
  `STATUS` int(11) NOT NULL DEFAULT '0' COMMENT '0 = OPEN, 1 = LOGIN',
  `FLAG` int(11) DEFAULT NULL COMMENT '0 = cu, 1 = pl',
  `CREATED_AT` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`ID`),
  UNIQUE KEY `UNIQUE` (`QR_CODE`)
