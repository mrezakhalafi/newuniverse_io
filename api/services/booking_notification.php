...
if (isset($raw) && !empty($raw)) {
    ...
    $branch_valid = ($Branch !== null) && ($Branch !== '') && (strlen($Branch) <= 64);
    $bcode_valid = ($Booking !== null) && ($Booking !== '') && (strlen($Booking) <= 32);
    $service_valid = ($Service !== null) && ($Service !== '') && (strlen($Service) <= 64);
    $api_valid = ($Api !== null) && ($Api !== '');

    if ($to_valid && $branch_valid && $bcode_valid && $service_valid && $Date !== null && $api_valid) {
