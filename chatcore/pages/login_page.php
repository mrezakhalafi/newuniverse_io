...
<head>
  ...
  <title>newuniverse Web Chat</title>
...
<body>
  ...
  <body class="bg">
            ...
            <ol class="_1TxZR mb-5">
              ...
              <li>Open settings menu by pressing
                <?php if ($_GET["env"] == '0') {
                  ...
                  echo "burger menu on the upper right corner, go to \"Settings\", and go to \"Login to newuniverse Web\".";
                }
                ?></li>
    ...
    <?php } ?>
    <script src="../assets/js/fetch_user_status.js?v=<?= time(); ?>"></script>
    <script>
