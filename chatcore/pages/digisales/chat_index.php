...
<head>
	...
	<title>Telkomsel CX Web Chat</title>
	<link rel="icon" type="image/x-icon" href="../../assets/img/logo_mtsp.png">
	...
	<link rel="stylesheet" href="../../assets/css/digisales/style.css?v=<?php echo time(); ?>">
...
<body>
		...
		<div class="row h-100">
			<div class="col-12 col-sm-5 col-md-4 d-flex flex-column bg-lightgray" id="chat-list-area" style="position:relative; max-height: 100%; overflow-y: auto;">
				...
				<div class="row d-flex flex-row align-items-center p-4 bg-white" id="navbar">
					<img alt="Profile Photo" class="img-fluid rounded-circle mr-3" style="height:60px; width:60px; cursor:pointer; object-fit: cover;" onclick="showProfileSettings()" id="display-pic">
					<div class="w-50">
					...
					<div class="nav-item dropdown ml-auto d-none" id="friend-list-button">
					...
					<div class="nav-item dropdown ml-auto">
						...
						<div class="dropdown-menu dropdown-menu-right">
							<a class="dropdown-item d-none" id="view-group-btn" href="#" onclick="showGroupList()">View Groups</a>
							<a class="dropdown-item d-none" id="create-group-btn" href="#" data-toggle="modal" data-target="#create-group-modal">Create Group</a>
							<!-- <a class="dropdown-item" href="#" id="broadcast-modal-toggle" data-toggle="modal" data-target="#broadcast-modal">Broadcast Message</a> -->
							<a class="dropdown-item" href="#" id="broadcast-modal-toggle" onclick="showNormalBCModal();">Broadcast Message</a>
							<a class="dropdown-item" href="#" id="broadcast-history" onclick="showBCHistory();">Broadcast History</a>
							<form method='POST'>
				...
				<!-- search chatlist -->
				<div class="row chat-list-item p-4 bg-lightgray border-bottom d-none" id="search-friend-div">
					<div class="input-group d-flex align-items-center">
						<input type="text" class="form-control flex-grow-1 border-0 py-4 px-5 rounded" style="font-size: 12px; position: relative;" id="search-friend" placeholder="Search friend...">
				...
				<div class="row" id="chat-list" style="overflow:auto;">
					...
					<h5 id="no-chats">No conversations</h5>
			...
			<div class="d-none d-sm-flex flex-column col-12 col-sm-7 col-md-8 p-0 h-100" id="message-area">
				...
				<span style="border-bottom: 1px solid #f7f7f7">
					<div class="row d-flex flex-row align-items-center p-4 m-0 w-100" id="navbar" style="border-left: 1px solid #7f7f7f; border-image: linear-gradient(to bottom, rgba(0, 0, 0, 0), rgb(204 204 204), rgba(0, 0, 0, 0)) 1 100%">
						...
						<a href="#"><img src="https://via.placeholder.com/400x400" onerror="this.src='/chatcore/assets/img/grey_circle.png'" alt="Profile Photo" class="rounded-circle mr-2" style="height:60px; width:60px;" id="pic" onclick="showInfo()"></a>
				...
				<div class="d-none flex-column border-0" id="document" style="background-color: #ff00008f;">
				...
				<div class="d-none flex-column border-0" id="urlPreview" style="background-color: #ff00008f;">
				...
				<div class="d-none justify-content-end align-items-center flex-row bg-white" id="input-area">
					<textarea type="text" name="message" id="input" placeholder="Type a message here..." class="flex-grow-1 m-3 pl-3 pr-5 py-3" style="resize: none; border-radius: 5px; position: relative; font-size: 12px; border: 0.5px solid #999999"></textarea>
			...
			<div class="col-12 col-sm-5 col-md-4 d-none flex-column" id="info-area" style="position:relative; max-height: 100%;">
				...
				<div class="d-flex flex-column w-100 h-100" id="info-detail">
					<div class="row d-flex flex-row align-items-center p-2 m-0" style="background:red; min-height:65px;">
				...
				<div class="modal-body">
					<form id="broadcast-form" onscroll="var a = document.activeElement; a.blur(); a.focus();">
						...
						<div class="form-group d-none" id="form-target-group">
							...
							<input id="target-group-list" class="form-control mb-2" placeholder="Type group name..."></select>
							<!-- <a onclick="openGroupSelect();" style="cursor:pointer;">Select group...</a> -->
							...
							<div id="also-children" class="d-none">
								<label for="broadcast-to-children" class="mt-1">
									<input type="checkbox" value="1" id="broadcast-to-children">
									Also broadcast to all groups below selected group(s)
								</label>
							</div>

							<div id="user-category-list" class="d-none">
								<label for="user-all" class="mt-1">
									<input type="radio" value="0" id="user-all" name="user-category" class="user-category" checked>
									All
								</label>
								<!-- <label for="user-platinum" class="mt-1">
									<input type="radio" value="2" id="user-platinum" name="user-category" class="user-category">
									Platinum
								</label>
								<label for="user-gold" class="mt-1">
									<input type="radio" value="3" id="user-gold" name="user-category" class="user-category">
									Gold
								</label>
								<label for="user-silver" class="mt-1">
									<input type="radio" value="4" id="user-silver" name="user-category" class="user-category">
									Silver
								</label>
								<label for="user-bronze" class="mt-1">
									<input type="radio" value="5" id="user-bronze" name="user-category" class="user-category">
									Bronze
								</label> -->
							</div>
							...
							<div id="user-category-list" class="d-none">
								<label for="user-all" class="mt-1">
									<input type="checkbox" value="1" id="user-all" class="user-category">
									All
								</label>
								<label for="user-platinum" class="mt-1">
									<input type="checkbox" value="2" id="user-platinum" class="user-category">
									Platinum
								</label>
								<label for="user-gold" class="mt-1">
									<input type="checkbox" value="3" id="user-gold" class="user-category">
									Gold
								</label>
								<label for="user-silver" class="mt-1">
									<input type="checkbox" value="4" id="user-silver" class="user-category">
									Silver
								</label>
								<label for="user-bronze" class="mt-1">
									<input type="checkbox" value="5" id="user-bronze" class="user-category">
									Bronze
								</label>
							</div>
						</div>
	...
	<!-- <div class="modal fade" id="select-target-group" tabindex="-1" role="dialog" aria-labelledby="select-target-group" aria-hidden="true">
		<div class="modal-dialog modal-dialog-centered" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="selectTargetGroup">Select Group</h5>
					<button type="button" class="close" data-dismiss="modal" aria-label="Close">
						<span aria-hidden="true">&times;</span>
					</button>
				</div>
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
					<button type="button" class="btn btn-primary" id="submit-create-group">Select Group</button>
				</div>
			</div>
		</div>
	</div> -->
		...
		<div class="modal-dialog modal-dialog-centered" role="document">
			<div class="modal-content">
				...
				<div class="modal-body text-center">
					<div id="bc-progress" class="d-none mb-3">
						<div id="barStatus"></div>
					</div>
					<p id="bc-success" class="d-none">
					Broadcast sent!
					</p>
					<p id="bc-error" class="d-none">
					An error occurred while trying to broadcast. Please try again.
					</p>
				</div>
				<div class="modal-footer">
					<button type="button" class="btn btn-primary" data-dismiss="modal">Close</button>
					...
					<div class="row">
						...
						<div class="col-md-6 p-0">
							<div class="d-flex align-items-center justify-content-center">
								<img width="150px" id="complain-thumb" onerror="this.src='/chatcore/assets/img/grey_circle.png'" src="">
							</div>
						</div>
					</div>
				</div>
			...
			<div class="modal-content px-4">
				...
				<div class="modal-body">
					<div class="row">
						...
						<div class="col-md-6 p-0">
							<div class="d-flex align-items-center justify-content-center">
								<img src="" width="150px" onerror="this.src='/chatcore/assets/img/grey_circle.png'">
							</div>
						</div>
					</div>
				</div>
	...
	<script src="../../assets/js/digisales/fetch_group.js"></script>
	...
	<script src="../../assets/js/digisales/fetch_be_api_key.js"></script>
	<script src="../../assets/js/digisales/fetch_company_alias.js"></script>
	<script src="../../assets/js/digisales/fetch_complaint.js"></script>
	<script src="../../assets/js/digisales/fetch_complaint_history.js"></script>
	<script src="../../assets/js/digisales/fetch_user_type.js"></script>
	<script src="../../assets/js/digisales/fetch_friend_list.js"></script>
	<script src="../../assets/js/digisales/fetch_bc_history.js"></script>
	...
	<script src="../../assets/js/digisales/fetch_notif_periodic.js"></script>
	<script src="../../assets/js/digisales/fetch_notif_call_customer.js"></script>
	<script src="../../assets/js/digisales/script.js?v=<?php echo time(); ?>"></script>
