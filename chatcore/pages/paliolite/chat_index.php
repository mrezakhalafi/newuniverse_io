...
<body>
		...
		<div class="row h-100">
			<div class="col-12 col-sm-5 col-md-4 d-flex flex-column" id="chat-list-area" style="position:relative; max-height: 100%; overflow-y: auto;">
				...
				<div class="chat-list-item flex-row w-100 px-2 py-1 border-bottom d-none" id="search-friend-div">
					<div class="input-group my-2">
						...
						<div class="input-group-append" style="margin-left: 2px;">
							...
							<button style="margin-left:5px; border-radius: 100%" class="btn btn-outline-secondary" type="button" id="search-friend-clear"><i class="fas fa-times"></i></button>
						</div>
					</div>
				</div>
				...
				<div class="d-flex flex-column w-100 h-100" id="profile-settings">
					<div class="row d-flex flex-row align-items-center p-2 m-0" style="background:#1799ad; min-height:65px;">
					...
					<div class="d-flex flex-column" style="overflow:auto;">
						...
						<div class="bg-white px-3 py-2">
							<div class="text-muted mb-2"><label for="input-name" style="font-size: small; color: #1799ad;">Your Name</label></div>
			...
			<div class="d-none d-sm-flex flex-column col-12 col-sm-7 col-md-8 p-0 h-100" id="message-area">
				...
				<div class="row flex-row align-items-center justify-content-center p-2 m-0 w-100 d-none" id="cc-bar" style="background-color:#ADD8E6;">
					<div class="d-flex flex-column">
						<div class="text-secondary font-weight-bold mx-auto" id="cc-convo">CONTACT CENTER CONVERSATION</div>
					</div>
				</div>
			...
			<div class="col-12 col-sm-5 col-md-4 d-none flex-column" id="info-area" style="position:relative; max-height: 100%;">
				...
				<div class="d-flex flex-column w-100 h-100" id="info-detail">
					...
					<div class="d-flex flex-column" style="overflow:auto;">
						<span style="margin-top: 20px;" class=" mx-auto"><img alt="Profile Photo" class="img-fluid rounded-circle justify-self-center" id="person-profile-pic"></span>
				...
				<div class="modal-body">
					<form id="broadcast-form" onscroll="var a = document.activeElement; a.blur(); a.focus();">
						...
						<div class="form-group" id="form-broadcast-survey">
							<label for="broadcast-link" class="col-form-label">Content Survey ID</label>
							<input class="form-control" id="broadcast-survey" placeholder="Enter Survey ID"></input>
						</div>
					...
					<div class="tab-content" id="myTabContent">
						<div class="chat-list-item flex-row w-100 px-2 py-1 border-bottom d-none" id="search-friend-fwd-div">
							<div class="input-group my-2">
								...
								<div class="input-group-append" style="margin-left: 2px;">
									<!-- <span class="input-group-text" id="search-friend-clear"><i class="fa fa-times"></i></span> -->
									<button style="margin-left: 5px; border-radius: 100%" class="btn btn-outline-secondary" type="button" id="search-friend-fwd-clear"><i class="fas fa-times"></i></button>
								</div>
							</div>
						</div>
	...
	<script src="../../assets/js/date-utils.js?v=<?= time() ?>"></script>
	<script src="../../assets/js/datastore.js?v=<?= time() ?>"></script>
	<script src="../../assets/js/fetch_messages.js?v=<?= time() ?>"></script>
	<script src="../../assets/js/fetch_bot_messages.js?v=<?= time() ?>"></script>
	<script src="../../assets/js/fetch_users.js?v=<?= time() ?>"></script>
	<script src="../../assets/js/fetch_user_profile.js?v=<?= time() ?>"></script>
	<script src="../../assets/js/fetch_group_member.js?v=<?= time() ?>"></script>
	<script src="../../assets/js/fetch_group.js?v=<?= time() ?>"></script>
	<script src="../../assets/js/fetch_subgroup.js?v=<?= time() ?>"></script>
	<script src="../../assets/js/fetch_discussion.js?v=<?= time() ?>"></script>
	<script src="../../assets/js/fetch_block_status.js?v=<?= time() ?>"></script>
	<script src="../../assets/js/paliolite/fetch_be_api_key.js?v=<?= time() ?>"></script>
	<script src="../../assets/js/paliolite/fetch_company_alias.js?v=<?= time() ?>"></script>
	<script src="../../assets/js/paliolite/fetch_complaint.js?v=<?= time() ?>"></script>
	<script src="../../assets/js/paliolite/fetch_complaint_history.js?v=<?= time() ?>"></script>
	<script src="../../assets/js/paliolite/fetch_user_type.js?v=<?= time() ?>"></script>
	<script src="../../assets/js/paliolite/fetch_friend_list.js?v=<?= time() ?>"></script>
	<script src="../../assets/js/fetch_message_periodic.js?v=<?= time() ?>"></script>
	<script src="../../assets/js/fetch_bot_msg_periodic.js?v=<?= time() ?>"></script>
	<script src="../../assets/js/fetch_user_periodic.js?v=<?= time() ?>"></script>
	<script src="../../assets/js/fetch_group_periodic.js?v=<?= time() ?>"></script>
	<script src="../../assets/js/fetch_discussion_periodic.js?v=<?= time() ?>"></script>
	<script src="../../assets/js/paliolite/fetch_notif_periodic.js?v=<?= time() ?>"></script>
	<script src="../../assets/js/paliolite/fetch_notif_call_customer.js?v=<?= time() ?>"></script>
	<script src="../../assets/js/paliolite/script.js?v=<?= time() ?>"></script>
